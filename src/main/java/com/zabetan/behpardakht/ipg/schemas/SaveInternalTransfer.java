 ...
 *         &lt;element name="request" type="{http://schemas.datacontract.org/2004/07/SunGard.Phase3.Cdm.Backend.Service.Contracts}InternalTransfers" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SaveInternalTransfer")
public class SaveInternalTransfer {
    ...
    protected JAXBElement<InternalTransfers> request;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link InternalTransfers }{@code >}
     *     
     */
    public JAXBElement<InternalTransfers> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<InternalTransfers> value) {
        this.request = value;
    }
