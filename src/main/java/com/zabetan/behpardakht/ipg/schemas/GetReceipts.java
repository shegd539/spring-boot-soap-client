 ...
 *         &lt;element name="search" type="{http://schemas.datacontract.org/2004/07/SunGard.Phase3.Cdm.Backend.Service.Contracts}SearchParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetReceipts")
public class GetReceipts {
    ...
    @XmlElementRef(name = "search", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<SearchParameters> search;
     ...
     *     
     */
    public JAXBElement<SearchParameters> getSearch() {
        return search;
    }
     ...
     *     
     */
    public void setSearch(JAXBElement<SearchParameters> value) {
        this.search = value;
    }
