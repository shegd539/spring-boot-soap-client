 ...
 *         &lt;element name="request" type="{http://schemas.datacontract.org/2004/07/SunGard.Phase3.Cdm.Backend.Service.Contracts}Disbursement" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateDisbursementsForFirm")
public class UpdateDisbursementsForFirm {
    ...
    protected JAXBElement<Disbursement> request;
     ...
     *     
     */
    public JAXBElement<Disbursement> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<Disbursement> value) {
        this.request = value;
    }
