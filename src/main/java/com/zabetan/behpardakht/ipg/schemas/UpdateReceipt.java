 ...
 *         &lt;element name="receipt" type="{http://schemas.datacontract.org/2004/07/SunGard.Phase3.Cdm.Backend.Service.Contracts}Receipt" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateReceipt")
public class UpdateReceipt {
    ...
    protected JAXBElement<Receipt> receipt;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Receipt }{@code >}
     *     
     */
    public JAXBElement<Receipt> getReceipt() {
        return receipt;
    }
     ...
     *     
     */
    public void setReceipt(JAXBElement<Receipt> value) {
        this.receipt = value;
    }
