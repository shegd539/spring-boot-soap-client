 ...
 *         &lt;element name="searchParameters" type="{http://schemas.datacontract.org/2004/07/SunGard.Phase3.Cdm.Backend.Service.Contracts}SearchParameters" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetDisbursementsForFirm")
public class GetDisbursementsForFirm {
    ...
    @XmlElementRef(name = "searchParameters", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<SearchParameters> searchParameters;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SearchParameters }{@code >}
     *     
     */
    public JAXBElement<SearchParameters> getSearchParameters() {
     ...
     *     
     */
    public void setSearchParameters(JAXBElement<SearchParameters> value) {
